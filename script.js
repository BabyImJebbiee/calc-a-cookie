document.addEventListener('DOMContentLoaded', () => {
  ...
  // ====== ข้อมูลคำถาม ======
  const questions = [
    { text: "ถ้า 0<𝜃<𝜋/2 จงหาค่าของ 1/tan𝜃 - tan𝜃", choices: ["2+√2", "2-√2", "2"], answer: 0 },
    ...
    { text: "ต้องการสร้างจำนวนที่มี 7 หลัก จากเลขโดด 7 ตัว คือ 1,2,3,4,5,6 โดยให้เลข 3 สองตัวอยู่ติดกัน จะสร้างได้ทั้งหมดกี่จำนวน", choices: ["720", "820", "740"], answer: 0 },
